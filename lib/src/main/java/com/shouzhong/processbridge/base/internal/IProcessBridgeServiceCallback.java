...
public interface IProcessBridgeServiceCallback extends IInterface {

    abstract class Stub extends Binder implements IProcessBridgeServiceCallback {

        private static final String DESCRIPTOR = " com.shouzhong.processbridge.base.internal.IProcessBridgeServiceCallback";

        public Stub() {
            this.attachInterface(this, DESCRIPTOR);
        }

        public static IProcessBridgeServiceCallback asInterface(IBinder obj) {
            if ((obj==null)) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (((iin!=null)&&(iin instanceof IProcessBridgeServiceCallback))) {
                return ((IProcessBridgeServiceCallback)iin);
            }
        ...
        private static class Proxy implements IProcessBridgeServiceCallback {
