...
import com.shouzhong.processbridge.base.wrapper.BaseWrapper;
...
public class TypeCenter {
    ...
    public Class<?> getClassType(BaseWrapper wrapper) throws ProcessBridgeException {
        ...
        if (wrapper.isName()) {
            ...
            if (name.equals("boolean")) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    throw new ProcessBridgeException(ErrorCodes.CLASS_NOT_FOUND,
    ...
    public Class<?>[] getClassTypes(BaseWrapper[] wrappers) throws ProcessBridgeException {
    ...
    public Method getMethod(Class<?> clazz, MethodWrapper methodWrapper) throws ProcessBridgeException {
        ...
        if (methodWrapper.isName()) {
            ...
            if (method == null) {
                throw new ProcessBridgeException(ErrorCodes.METHOD_NOT_FOUND,
